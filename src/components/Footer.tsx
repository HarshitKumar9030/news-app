...
const FooterLink = ({ icon: Icon, href, label }: FooterLinkType) => {
  ...
  return (
    <Button
      variant="ghost"
      size="icon"
      className="group relative text-zinc-600 dark:text-zinc-400 transition-colors duration-300"
      asChild
    >
      <a
        href={href}
      ...
      >
        <Icon className="h-5 w-5 transition-transform duration-500 transform group-hover:scale-110 group-hover:text-zinc-900 dark:group-hover:text-zinc-100 relative z-10" />
        <AnimatePresence>
          {isHovered && (
            <motion.div
              className="absolute inset-0 bg-zinc-200 dark:bg-zinc-700 rounded-md"
...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="py-8 bg-zinc-50 dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex flex-col items-center md:items-start mb-6 md:mb-0">
            ...
            <motion.div
              className="text-[13px] leading-[1.24rem] font-medium text-zinc-600 dark:text-zinc-400"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <motion.div
            className="flex flex-col items-center md:items-end space-y-2 text-sm text-zinc-500 dark:text-zinc-400"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            className="mt-6 flex flex-col space-y-2 md:mt-0 text-sm text-zinc-500 dark:text-zinc-400"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center hover:text-zinc-700 dark:hover:text-zinc-200 transition-colors duration-200"
            >
              Built with Next.js
